...
const YEARLY_DISCOUNT_PCT = Math.round(
  (YEARLY_SAVINGS / (MONTHLY_PRICE * 12)) * 100
);
    ...
    <section id="pricing" className="py-24 px-6">
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold">Narxlar</h2>
  ...
  return (
    <div className="flex justify-center">
      <div className="inline-flex items-center gap-1 rounded-full border bg-muted/40 p-1">
        ...
        >
          Yillik
          <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded-full bg-brand-red text-white">
            −{YEARLY_DISCOUNT_PCT}%
          </span>
        </button>
      </div>
